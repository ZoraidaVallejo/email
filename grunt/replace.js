        ...
        shorten_classes: {
            options: {
                ...
                patterns: [
                    ...
                    { match: /mobile-padding-right/g, replacement: 'justia08' },
                    { match: /mobile-padding-bottom/g, replacement: 'justia09' },
                    { match: /mobile-padding-left/g, replacement: 'justia10' },
                    { match: /mobile-padding-horizontal-sides/g, replacement: 'justia11' },
                    { match: /mobile-padding-vertical-sides/g, replacement: 'justia12' },
                    { match: /mobile-padding-full/g, replacement: 'justia13' },
                    { match: /mobile-padding-uneven-top/g, replacement: 'justia14' },
                    { match: /mobile-padding-uneven-bottom/g, replacement: 'justia15' },
                    { match: /mobile-padding-uneven-full/g, replacement: 'justia16' },
                    { match: /mobile-no-padding-top/g, replacement: 'justia17' },
                    { match: /mobile-no-padding-bottom/g, replacement: 'justia18' },
                    { match: /mobile-no-padding-horizontal-sides/g, replacement: 'justia19' },
                    { match: /mobile-no-float/g, replacement: 'justia20' },
                    { match: /mobile-no-border/g, replacement: 'justia21' }
                ]
            },
            files: allTemplates
        },
